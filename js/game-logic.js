...
export function saveGameState() {
    ...
    localStorage.setItem('alpha_score', state.score); // 점수 별도 저장
    localStorage.setItem('alpha_best', state.best);   // 베스트 별도 저장
}
